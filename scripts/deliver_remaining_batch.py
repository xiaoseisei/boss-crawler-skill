# -*- coding: utf-8 -*-
"""剩余8家中小企业闭环投递脚本
与此前已完成的 #18、#24 共同组成完整的 10 家交付闭环。
严格遵循：
1. 详情页「继续沟通」与弹窗「已发送」强拦截
2. 聊天室已有历史记录强拦截
...
TARGET_JOBS = [
    ...
    },
    {
        'idx': 37,
        'company': '北京骄阳永续科技',
        'position': 'AI 流程优化专员（FDE 工程师）',
        'link': 'https://www.zhipin.com/job_detail/c3da0784cc65b0c20nJ63Ni4EFtR.html',
        'greeting': (
            "【随时到岗/可实习6个月/每周5天】您好！我是自动化专业本科生夏子聪，求职贵司的 AI 流程优化专员（FDE 工程师）岗位。"
            "我专注于大模型工作流设计与工程化交付：主导完成过 GraphRAG 智能问答系统（原声引用精度 97.5%、响应 0.82 秒），"
            "并搭建过基于 FastAPI 的 Agent 平台与自动化质检流水线。熟练运用 Python 开发流程自动化工具，具备高效的现场问题定位与解决能力。"
            "附件已上传针对贵司岗位定制的简历长图，诚盼您的查阅与评估。非常期待能有机会与您进一步沟通！"
        ),
        'image': os.path.abspath(r'assets/2026-09-18_11-31-40_fde_agent_sme/deliver/#37-北京骄阳永续科技-AI 流程优化专员（FDE 工程师）/夏子聪-AI 流程优化专员（FDE 工程师）.png'),
        'run_dir': 'assets/2026-09-18_11-31-40_fde_agent_sme'
    }
]
...
def deliver_one_job(dp, job):
    ...
    if dialog:
        dtext = dialog.text
        # 精确匹配沟通上限关键词，防止把公司福利里的“无上限”误判为风控
